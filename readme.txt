...
It auto generates the angular routing, an angular service for API access and merges all javascript files into a single requiest.
...
1. All the partial views should be in /views/
